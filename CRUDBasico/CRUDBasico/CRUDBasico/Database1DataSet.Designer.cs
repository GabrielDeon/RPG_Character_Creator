...
namespace CRUDBasico {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientesRow AddClientesRow(string Nome, System.DateTime DataNascimento, int Idade, string CPF, double Altura, double Peso, CidadesRow parentCidadesRowByFK_CLIENTES_CIDADES) {
        ...
        public partial class ClientesRow : global::System.Data.DataRow {
            ...
            public double Altura {
                get {
                    try {
                        return ((double)(this[this.tableClientes.AlturaColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public double Peso {
                get {
                    try {
                        return ((double)(this[this.tableClientes.PesoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Peso\' in table \'Clientes\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableClientes.PesoColumn] = value;
                }
            }
            ...
            public bool IsPesoNull() {
                return this.IsNull(this.tableClientes.PesoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPesoNull() {
                this[this.tableClientes.PesoColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace CRUDBasico.Database1DataSetTableAdapters {
    ...
    public partial class CidadesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUDBasico.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Fill(Database1DataSet.CidadesDataTable dataTable) {
        ...
        public virtual Database1DataSet.CidadesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.CidadesDataTable dataTable = new Database1DataSet.CidadesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.CidadesDataTable dataTable) {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([ID_Cliente] = @Original_ID_Cliente) AND ([Nome] = @Original_Nome) AND ([DataNascimento] = @Original_DataNascimento) AND ((@IsNull_Idade = 1 AND [Idade] IS NULL) OR ([Idade] = @Original_Idade)) AND ([CPF] = @Original_CPF) AND ((@IsNull_Altura = 1 AND [Altura] IS NULL) OR ([Altura] = @Original_Altura)) AND ((@IsNull_Peso = 1 AND [Peso] IS NULL) OR ([Peso] = @Original_Peso)) AND ([ID_Cidade] = @Original_ID_Cidade))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clientes] ([Nome], [DataNascimento], [Idade], [CPF], [Altura], [Peso], [ID_Cidade]) VALUES (@Nome, @DataNascimento, @Idade, @CPF, @Altura, @Peso, @ID_Cidade);
SELECT ID_Cliente, Nome, DataNascimento, Idade, CPF, Altura, Peso, ID_Cidade FROM Clientes WHERE (ID_Cliente = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Nome", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Nome", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Nome] = @Nome, [DataNascimento] = @DataNascimento, [Idade] = @Idade, [CPF] = @CPF, [Altura] = @Altura, [Peso] = @Peso, [ID_Cidade] = @ID_Cidade WHERE (([ID_Cliente] = @Original_ID_Cliente) AND ([Nome] = @Original_Nome) AND ([DataNascimento] = @Original_DataNascimento) AND ((@IsNull_Idade = 1 AND [Idade] IS NULL) OR ([Idade] = @Original_Idade)) AND ([CPF] = @Original_CPF) AND ((@IsNull_Altura = 1 AND [Altura] IS NULL) OR ([Altura] = @Original_Altura)) AND ((@IsNull_Peso = 1 AND [Peso] IS NULL) OR ([Peso] = @Original_Peso)) AND ([ID_Cidade] = @Original_ID_Cidade));
SELECT ID_Cliente, Nome, DataNascimento, Idade, CPF, Altura, Peso, ID_Cidade FROM Clientes WHERE (ID_Cliente = @ID_Cliente)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Nome", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Nome", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID_Cliente, Nome, DataNascimento, Idade, CPF, Altura, Peso, ID_Cidade FROM" +
                " dbo.Clientes";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ID_Cliente, string Original_Nome, System.DateTime Original_DataNascimento, global::System.Nullable<int> Original_Idade, string Original_CPF, global::System.Nullable<double> Original_Altura, global::System.Nullable<double> Original_Peso, int Original_ID_Cidade) {
            ...
            if ((Original_Altura.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((double)(Original_Altura.Value));
            }
            else {
            ...
            if ((Original_Peso.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((double)(Original_Peso.Value));
            }
            else {
                this.Adapter.DeleteCommand.Parameters[8].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[9].Value = global::System.DBNull.Value;
            }
            this.Adapter.DeleteCommand.Parameters[10].Value = ((int)(Original_ID_Cidade));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.DeleteCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Nome, System.DateTime DataNascimento, global::System.Nullable<int> Idade, string CPF, global::System.Nullable<double> Altura, global::System.Nullable<double> Peso, int ID_Cidade) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Original_Altura.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((double)(Original_Altura.Value));
            }
            else {
            ...
            if ((Original_Peso.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((double)(Original_Peso.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, System.DateTime DataNascimento, global::System.Nullable<int> Idade, string CPF, global::System.Nullable<double> Altura, global::System.Nullable<double> Peso, int ID_Cidade, int Original_ID_Cliente, string Original_Nome, System.DateTime Original_DataNascimento, global::System.Nullable<int> Original_Idade, string Original_CPF, global::System.Nullable<double> Original_Altura, global::System.Nullable<double> Original_Peso, int Original_ID_Cidade) {
            return this.Update(Nome, DataNascimento, Idade, CPF, Altura, Peso, ID_Cidade, Original_ID_Cliente, Original_Nome, Original_DataNascimento, Original_Idade, Original_CPF, Original_Altura, Original_Peso, Original_ID_Cidade, Original_ID_Cliente);
        }
    }
